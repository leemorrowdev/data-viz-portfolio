...
[Lexical environments](https://www.ecma-international.org/ecma-262/#sec-lexical-environments) are basically JavaScript's internal implementation of scopes. 
...
Its worth noting that there are three additional lexical environments subclasses that provide support for environments that require unique attributes or additional functionality:
...
[Execution contexts](https://www.ecma-international.org/ecma-262/#sec-execution-contexts) are used with the execution context stack to track the applications execution.
...
**Note:** This is why people sometimes say the `this` keyword represents the environments `context`.
...
The [execution context stack](https://www.ecma-international.org/ecma-262/#execution-context-stack) 
