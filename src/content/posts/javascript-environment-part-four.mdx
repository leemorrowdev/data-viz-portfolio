...
ECMAScript standards explicitly state [let and const](https://www.ecma-international.org/ecma-262/#sec-let-and-const-declarations) 
...
JavaScript is an interpreted language. ...Or at very least its definitely not a compiled language in the traditional sense.
